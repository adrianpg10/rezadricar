...
<nav id="menu-principal">
    ...
    <main>
        ...
        <nav id="enlacecontacto">
            <p><a onclick="location.href='index.php'">Inicio</a> &#x25B6; <small>Contacto</small></p>
        </nav>

        <picture>
            <img src="images/contacta.PNG" alt="contacta" id="contacta">
        </picture>

        <div id="contenedorcontacto">

            <section class="itemscontacto">
                <div class="titulocontacto">
                    <h2>HORARIO Y CONTACTO</h2>
                </div>
                <p>900 154 789</p>
                <p>rclientes@rcars.com</p>
                <p>de 09:00 a 20:00h</p>
        ...
        <section class="itemscontacto">
                ...
                <p>900 123 357</p>
                <p>Lunes a Jueves de 8:00 a 15:00 y de 16:00 a 20:00</p>
                <p>Viernes de 10:00 a 13:00 y de 15:00 a 19:00</p>
        ...
        <section class="itemscontacto">
                ...
                <p>soporterezadricar@rcars.com</p>
                <p>Laborables de 9:00 a 19:00</p>
